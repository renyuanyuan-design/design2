...
(function () {
  ...
  /* ---------- 技能 / 兴趣 抽卡 ---------- */
  const SKILLS = [
    { e: '📝', label: '公文写作', tag: '汇报材料', back: '汇报材料 / 会议纪要 / 工作简报。' },
    { e: '📊', label: '数据分析', tag: '万级数据处理', back: 'Excel / Python / Stata / SPSS' },
    { e: '🌿', label: '绿色金融', tag: '业务分析', back: '曾对电-碳-金融体系 44.87 亿数据进行业务分析。' },
    { e: '🔍', label: '行业研究', tag: '深度报告', back: '产业链跟踪、深度报告撰写。' },
    { e: '💹', label: '金融工具', tag: '估值建模', back: 'Wind/Choice、估值建模。' },
    { e: '🗂️', label: '档案管理', tag: '标准化归档', back: '底稿标准化归档、台账维护。' },
    { e: '🤝', label: '跨部门协同', tag: '多线联动', back: '多线联动、沟通能力强。' },
    { e: '📱', label: '新媒体运营', tag: '活动策划', back: '公众号排版、活动策划。' }
  ];
  const HOBBIES = [
    { e: '📚', label: '政策研读', tag: '产业机遇', back: '关注宏观经济与产业政策动向，习惯从政策文件中捕捉行业机遇。' },
    { e: '🏸', label: '羽毛球运动', tag: '团队协作', back: '擅长双打配合，享受团队协作与竞技对抗。' },
    { e: '📷', label: '摄影记录', tag: '定格瞬间', back: '喜欢用镜头记录生活瞬间，擅长人像与风景拍摄。' },
    { e: '✍️', label: '阅读写作', tag: '持续输出', back: '年阅读量 30+ 本，习惯用文字沉淀思考，保持持续输出。' },
    { e: '🎤', label: '演讲辩论', tag: '逻辑表达', back: '多次参与校级辩论赛，逻辑表达与临场反应能力突出。' },
    { e: '🤝', label: '志愿服务', tag: '热心公益', back: '累计志愿时长 200+ 小时，热心公益与社区服务。' },
    { e: '🚩', label: '党史学习', tag: '党建参与', back: '主动学习党史理论，积极参与党建活动与主题学习。' },
    { e: '✈️', label: '旅行探索', tag: '开阔视野', back: '走过 15+ 城市，在旅途中开阔视野、感知不同地域文化。' }
  ];
